...
\begin{document}
	...
	\begin{frame}{Análisis de Trayectoria Vertical: Velocidad y Posición}
	\centering
		\begin{columns}
	\begin{column}{0.4\textwidth}
		\begin{itemize}
			\item \textbf{Perfil de velocidad:} Incremento limitado por aceleración máxima.
			\item Inicia a frenar a aproximadamente la mitad de la trayectoria.
			\item \textbf{Conclusión técnica:} La trayectoria no está limitada como en el caso anterior.
		\end{itemize}
	\end{column}
	...
	\begin{column}{0.6\textwidth}
		\begin{figure}
			\centering
			% Reemplaza por tus nombres de archivo reales
			\includegraphics[width=0.7\textwidth]{verticaul.png}\vspace{-5mm}
			\caption{Gráficos de posición y velocidad vs. tiempo.}
		\end{figure}
	\end{column}
\end{columns}
